...
const policyIndicatorsByOrg={
  "재정경제부":[
    {id:"consumer-price-inflation",name:"소비자물가상승률",value:2.3,valueDisplay:"2.3%",unit:"%",year:2025,sourceId:"kosis-consumer-price",sourceRefs:["kosis-consumer-price"],datasetId:"KOSIS",summary:"소비자물가 상승 폭. 거시경제 안정과 체감물가 관리의 대표 지표.",trendDirection:"down",trendLabel:"전년 3.6% → 2.3%"},
    {id:"national-debt-gdp",name:"국가채무비율",value:48.4,valueDisplay:"48.4%",unit:"% GDP",year:2025,sourceId:"e-nara-fiscal-soundness",sourceRefs:["e-nara-fiscal-soundness"],datasetId:"e-나라지표",summary:"재정 건전성을 보여주는 핵심 지표. 본예산·정부안 논의와 함께 자주 참조됨.",trendDirection:"up",trendLabel:"전년 47.4% → 48.4%"}
  ],
  "고용노동부":[
    {id:"employment-rate-15-64",name:"15~64세 고용률",value:70.3,valueDisplay:"70.3%",unit:"%",year:2025,sourceId:"e-nara-employment-rate",sourceRefs:["e-nara-employment-rate"],datasetId:"e-나라지표",summary:"경제활동 가능 연령대의 고용 수준. 노동시장 체력과 정책 성과를 함께 보여준다.",trendDirection:"up",trendLabel:"전년 69.8% → 70.3%"},
    {id:"youth-employment-rate",name:"청년 고용률",value:46.8,valueDisplay:"46.8%",unit:"%",year:2025,sourceId:"e-nara-youth-employment",sourceRefs:["e-nara-youth-employment"],datasetId:"e-나라지표",summary:"청년층 일자리 상황을 보여주는 대표 지표.",trendDirection:"flat",trendLabel:"전년 대비 소폭 개선"}
  ],
  "교육부":[
    {id:"private-education-monthly",name:"학생 1인당 월평균 사교육비",value:47.4,valueDisplay:"47.4만원",unit:"만원/월",year:2024,sourceId:"kosis-private-education",sourceRefs:["kosis-private-education"],datasetId:"KOSIS",summary:"초중고 학생의 사교육비 부담 수준. 교육격차·공교육 체감도와 자주 같이 해석된다.",trendDirection:"up",trendLabel:"전년 43.4만원 → 47.4만원"},
    {id:"higher-education-enrollment",name:"고등교육기관 진학률",value:76.2,valueDisplay:"76.2%",unit:"%",year:2024,sourceId:"kosis-higher-education",sourceRefs:["kosis-higher-education"],datasetId:"KOSIS",summary:"고등학교 졸업자의 대학 등 진학 비중.",trendDirection:"down",trendLabel:"전년 대비 소폭 하락"}
  ],
  "보건복지부":[
    {id:"total-fertility-rate",name:"합계출산율",value:0.75,valueDisplay:"0.75명",unit:"명",year:2024,sourceId:"kosis-fertility-rate",sourceRefs:["kosis-fertility-rate"],datasetId:"KOSIS",summary:"가임여성 1명이 평생 낳을 것으로 기대되는 평균 출생아 수.",trendDirection:"up",trendLabel:"전년 0.72명 → 0.75명"},
    {id:"life-expectancy",name:"기대수명",value:83.5,valueDisplay:"83.5세",unit:"세",year:2024,sourceId:"kosis-life-expectancy",sourceRefs:["kosis-life-expectancy"],datasetId:"KOSIS",summary:"보건의료 성과와 건강수준을 보여주는 장기 지표.",trendDirection:"up",trendLabel:"전년 대비 완만한 증가"}
  ],
  "국토교통부":[
    {id:"housing-supply-rate",name:"주택보급률",value:102.5,valueDisplay:"102.5%",unit:"%",year:2024,sourceId:"e-nara-housing-supply",sourceRefs:["e-nara-housing-supply"],datasetId:"e-나라지표",summary:"가구 수 대비 주택 stock 규모. 공급 기반을 보는 기본 지표.",trendDirection:"up",trendLabel:"전년 102.1% → 102.5%"},
    {id:"public-transport-share",name:"대중교통 분담률",value:41.5,valueDisplay:"41.5%",unit:"%",year:2023,sourceId:"kosis-public-transport-share",sourceRefs:["kosis-public-transport-share"],datasetId:"KOSIS",summary:"도시권 이동에서 대중교통이 차지하는 비중. 교통정책·탄소감축과 함께 본다.",trendDirection:"flat",trendLabel:"코로나 이후 회복세"}
  ],
  "기후에너지환경부":[
    {id:"greenhouse-gas-emissions",name:"온실가스 총배출량",value:624.2,valueDisplay:"624.2MtCO₂eq",unit:"MtCO₂eq",year:2023,sourceId:"e-nara-ghg-emissions",sourceRefs:["e-nara-ghg-emissions"],datasetId:"e-나라지표",summary:"국가 탄소배출 총량. 기후대응 정책의 최상위 성과지표 중 하나.",trendDirection:"down",trendLabel:"전년 대비 감소"},
    {id:"renewable-generation-share",name:"재생에너지 발전 비중",value:9.6,valueDisplay:"9.6%",unit:"%",year:2024,sourceId:"e-nara-renewable-share",sourceRefs:["e-nara-renewable-share"],datasetId:"e-나라지표",summary:"전체 발전량 중 재생에너지가 차지하는 비중.",trendDirection:"up",trendLabel:"전년 8.9% → 9.6%"}
  ]
};
